...
ctx.logger.info('***** debug: MgmtWorker uses manager_host: {0}'.format(manager_host))
ctx.logger.info('***** debug: MgmtWorker uses rest_host: {0}'.format(rest_host))
ctx.logger.info('***** debug: MgmtWorker uses rest_protocol: {0}'.format(rest_protocol))
ctx.logger.info('***** debug: MgmtWorker uses rest_port: {0}'.format(rest_port))
ctx.logger.info('***** debug: MgmtWorker uses security_enabled: {0}'.format(security_enabled))
ctx.logger.info('***** debug: MgmtWorker uses ssl_enabled: {0}'.format(ssl_enabled))
ctx.logger.info('***** debug: MgmtWorker uses cloudify_username: {0}'.format(cloudify_username))
ctx.logger.info('***** debug: MgmtWorker uses cloudify_password: {0}'.format(cloudify_password))
ctx.logger.info('***** debug: MgmtWorker uses verify_certificate: {0}'.format(verify_certificate))
ctx.logger.info('***** debug: MgmtWorker uses ssl_certificate: {0}'.format(ssl_certificate))
